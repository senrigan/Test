...
public class BlueCoatDriverTest {
	...
	public static void SetUP(){
		clientAdmin=TestManager.getIntance().getClientManager();
		clientAdmin.setDevice(TestManager.getIntance().getSillyDevice().getDevice());
	}
